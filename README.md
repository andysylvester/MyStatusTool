...
To start making posts in MyStatusTool, click on the circle with an “m” in the upper right corner of the screen. This will bring up the admin page, and a dialog box will open asking for a username and password. Enter the username and password in app.js and click the OK button. The page will update to show a text area with the phrase "Type your text..." and a button to submit posts. A styling toolbar is available for text editing (the [medium-editor](https://yabwe.github.io/medium-editor/) toolbar. This toolbar supports styling of text (bold, italic, underline), creating links, and changing text size to headings 2 and 3. To use the toolbar, click and highlight the text to be styled. The toolbar will appear above the selected text. Click the appropriate button on the toolbar. If you are adding a link, a pop-up window will appear for the link URL. Paste the URL in the window and press the Enter key. 

When you make a post, the post will appear at the top of the screen. In the lower-left corner of the post, the timestamp will be a link to the page for that post. If other subscribed feeds have updated, their posts will appear as well as your post.
